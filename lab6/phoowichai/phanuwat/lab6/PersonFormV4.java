...
public class PersonFormV4 extends PersonFormV3 {
    ...
    private void updateMenuIcon() {
        // set icon of new menu
        ImageIcon newImg = new ImageIcon((getClass().getResource("images/new.jpg")));
        // set size image
        Image newIcon = newImg.getImage().getScaledInstance(20, 20, java.awt.Image.SCALE_SMOOTH);

        // set icon
        newMI.setIcon(new ImageIcon(newIcon));
    }
